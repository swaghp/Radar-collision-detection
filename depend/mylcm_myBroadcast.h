...
#ifndef _mylcm_myBroadcast_h
#define _mylcm_myBroadcast_h
...
typedef struct _mylcm_myBroadcast mylcm_myBroadcast;
struct _mylcm_myBroadcast
{
    int64_t    timestamp0;
    int32_t    objNum;
    mylcm_lidarObjInfor *objs;
};

/**
 * Create a deep copy of a mylcm_myBroadcast.
 * When no longer needed, destroy it with mylcm_myBroadcast_destroy()
 */
mylcm_myBroadcast* mylcm_myBroadcast_copy(const mylcm_myBroadcast* to_copy);

/**
 * Destroy an instance of mylcm_myBroadcast created by mylcm_myBroadcast_copy()
 */
void mylcm_myBroadcast_destroy(mylcm_myBroadcast* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _mylcm_myBroadcast_subscription_t mylcm_myBroadcast_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * mylcm_myBroadcast is received.
 */
typedef void(*mylcm_myBroadcast_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const mylcm_myBroadcast *msg, void *userdata);

/**
 * Publish a message of type mylcm_myBroadcast using LCM.
 *
 ...
 */
int mylcm_myBroadcast_publish(lcm_t *lcm, const char *channel, const mylcm_myBroadcast *msg);

/**
 * Subscribe to messages of type mylcm_myBroadcast using LCM.
 *
 ...
 */
mylcm_myBroadcast_subscription_t* mylcm_myBroadcast_subscribe(lcm_t *lcm, const char *channel, mylcm_myBroadcast_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by mylcm_myBroadcast_subscribe()
 */
...
/**
 * Encode a message of type mylcm_myBroadcast into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to mylcm_myBroadcast_encoded_size().
...
/**
 * Decode a message of type mylcm_myBroadcast from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with mylcm_myBroadcast_decode_cleanup().
 *
 ...
 */
int mylcm_myBroadcast_decode(const void *buf, int offset, int maxlen, mylcm_myBroadcast *msg);

/**
 * Release resources allocated by mylcm_myBroadcast_decode()
 * @return 0
 */
int mylcm_myBroadcast_decode_cleanup(mylcm_myBroadcast *p);

/**
 * Check how many bytes are required to encode a message of type mylcm_myBroadcast
 */
